...
class TestEKFOneStepConvergence(unittest.TestCase):


    #x prediction is good. tested with the same atmospheric density and got the same answer
    ...
    def test_x_prediction(self):
        ...
        print("x prediction: ", np.array2string(x_pred, formatter={'float_kind':lambda x: "%.15f" % x}))
    ...
    def test_F_prediction(self):
        ...
        print("F prediction: ", np.array2string(np.diag(F_pred), formatter={'float_kind':lambda x: "%.15f" % x}))
    ...
    def test_innovation(self):
        ...
        print("THIS IS THE INNOVATION")
        print(np.array2string(Z, formatter={'float_kind':lambda x: "%.15f" % x}))

        print("this is C")
        print(np.array2string(C, formatter={'float_kind':lambda x: "%.15f" % x}))
    ...
    def test_kalman_gain(self): 
        ...
        assert_array_almost_equal(L, L_julia, decimal=6)
    ...
    def test_x_update(self): 
        ...
        assert_array_almost_equal(EKF_test.x, x_update, decimal=6)
    ...
    def test_F_update(self): 
        ...
        assert_array_almost_equal(EKF_test.F, F_update, decimal=6)
